        ...
        models.forEach((mod, idx) => {
            ...
            card.innerHTML = `
                ...
                <div class="model-3d-box">
                    <model-viewer src="${mod.file}" camera-orbit="40deg 75deg auto" disable-zoom disable-pan shadow-intensity="1.5" exposure="1" interaction-prompt="none" style="width:100%; height:100%;"></model-viewer>
                </div>
